...
class Materias(models.Model):
    ...
    horaInicio = models.CharField(max_length=255, blank=True, null=False)
    horaFin = models.CharField(max_length=255, blank=True)
    salon = models.CharField(max_length=50, blank=False, null=False)
    programa_educativo = models.CharField(max_length=100, blank=False, null=False)
    creation = models.DateTimeField(auto_now_add=True, null=True, blank=True)
    update = models.DateTimeField(null=True, blank=True)

    def __str__(self):
        return "Datos de la Materia"+ self.nombre